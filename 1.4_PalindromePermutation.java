...
/** Solution: A palindrome should have even numbers of chars and at most one odd cha
 * Use an Array (or a hash table) to count the number of chars appear
 * Iterate through the hash table to ensure that no more than one char has an odd count
 */
