...
/** You are reading in a stream of integers. Implement a method track (int x), which is called when each number
 * is generated, and the method getRankOfNumber(int x), which returns the number of values less than or equal
 * to x (not including x itself).
 */

public class RankfromStream {
    /** Construct a binary search tree and use in-order traversal to keep a counter as we traverse
     *
     */
