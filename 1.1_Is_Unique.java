...
public class Is_Unique {
    ...
    /*
     * this method explore the limited number of char in a string and use a boolean
     * array
     * to track if a certain char is in the string or not
     */
    public static boolean isUniqueChars(String str) {
        // Assume the string is ASCII code, Unicode would be 256. Clarify with your
        // interviewer
        if (str.length() > 128) {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            if (char_set[val])
                return false; // if the integer's corresponding boolean is true , then return flase
...
/**
 * Handwriting issue:
 * forget how to claim the method and how to define a class
 * forget to use the charAt method
 * mistake on how to define a array
 * 
 */