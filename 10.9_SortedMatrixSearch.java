...
public class SortedMatrixSearch {
    /** Solution
     * Since each row and column is sorted, it means that the diagonal is sorted as well
     * When seaching along the diagonal for a particular element, its topleft quadrant is all smaller
     * than the element, and all the bottom right quadrant are larger than it.
     * So we can partition the grid into four quadrants and recursively search the lower left quadrant
     * and the upper right quadrant using binary search.
     */
