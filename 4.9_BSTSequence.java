 ...
 * and inserting each element. Given a BST with distinct elements,
 *  print all possible arrays that could have led to this tree
 */

public class BSTSequence {
    /** Solution
     * Since it's a BST. left < center < right, so it does not matter which child come in first
     * Do this recursively by weaving the arrays together
     * Weaving means merging two arrays in all possible ways, while keeping the elements within
     * each array in the same relative order
     * Since no duplicates in the original array sets, no need to worry during weaving
     */
