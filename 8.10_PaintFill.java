...
/** Given a screen presented by a two-D array of colors, a point, and a new color
 * fill in the surrounding area until and color changes from the original color
 */
...
public class PaintFill {
    ...
    public static boolean PaintFill(Color[][] screen, int r, int c, Color ocolor, Color ncolor) {
        ...
        if(screen[r][c] == ocolor) {                //If this is the original color we want to overpaint
            screen[r][c] = ncolor;                  //this is the new color
    ...
    public static void main(String[] args) {
        /* generate a screen with background color */
        int N = 10;
        ...
        /* randomly populate original color to be painted/covered */
        for (int i = 0; i < 100; i++) {
